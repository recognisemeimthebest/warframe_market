...
_RIVEN_KO_MANUAL: dict[str, str] = {
    ...
    "볼터": "boltor", "브라톤": "braton", "톤코르": "tonkor",
    "시바리스": "tiberon", "시놉시스": "synapse", "타이그리스": "tigris",
    "벡티스": "vectis", "토리드": "torid", "자르": "zarr",
    "아크셀트라": "acceltra", "트럼나": "trumna", "스타타": "stahlta",
    "엔비디아": "envoy", "풀민": "fulmin", "코르바스": "corvas",
    "그램": "gram", "니카나": "nikana", "오르토스": "orthos",
    "스트로파": "stropha", "크로넨": "kronen", "레시온": "lesion",
    "갈라틴": "galatine", "리퍼": "reaper_prime", "파라세시스": "paracesis",
    "브로큰 워": "broken_war", "스킨나": "skiajati",
    "캐치문": "catchmoon", "스포어레이서": "sporelacer", "툼핑거": "tombfinger",
    "게이즈": "gaze", "래틀거츠": "rattleguts", "버미스플라이서": "vermisplicer",
    "플레이그 크리패스": "plague_kripath", "플레이그 키워": "plague_keewar",
    "세프판": "sepfahn", "시아스": "cyath", "발라": "balla", "도크람": "dokrahm",
    "누코르": "nukor", "에피타프": "epitaph", "파이라나": "pyrana",
    "아크리드": "acrid", "아토모스": "atomos", "스태티코르": "staticor",
    "유포나": "euphona_prime", "레이저 라이플": "laser_rifle",
    "스위퍼": "sweeper", "벌클록": "vulklok", "스팅어": "stinger",
    "마우솔론": "mausolon", "그라틀러": "grattler", "플럭터스": "fluctus",
    "임퍼레이터": "imperator", "아양가": "kuva_ayanga",
    "히스트릭스": "hystrix", "판테라": "panthera", "오그리스": "ogris",
    "자르르": "zarr", "카락": "karak", "헥": "hek", "마라": "mara",
    "드라코": "drakgoon", "코네": "kohm", "페레나": "ferrox",
    "렉스": "lex", "브론코": "bronco", "디스페어": "despair",
    "이코르": "ichor", "에텔라": "etheria", "덱스트라": "dex_pixia",
    "오쿠코르": "ocucor", "팔코르": "falcor", "바타코르": "battacor",
    "엑서지스": "exergis", "헬리오코르": "heliocor",
    "헤이트": "hate", "드레드": "dread", "디스페어": "despair",
    "워": "war", "브로큰워": "broken_war",
    "부르디": "burdi", "세빈탈론": "sheev", "쉬브": "sheev",
    # 모드/아케인 한글명
    "바이탈리티": "vitality", "혈기": "vitality",
    "버서커 퓨리": "berserker_fury", "광전사": "berserker_fury",
    "소용돌이": "whirlwind", "휠윈드": "whirlwind",
    "치명적 가속": "fatal_acceleration",
    "점화 에이전트": "combustion_beam",
    "블러드 러쉬": "blood_rush",
